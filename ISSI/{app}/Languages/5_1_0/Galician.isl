; *** Inno Setup version 5.1.0+ Galician messages ***
;
...
;
; $jrsoftware: issrc/Files/Languages/Galician.isl,v 1.1 2005/03/05 22:30:00 medulio Exp $
...
ExitSetupMessage=A instalación non se completou. Se saes agora o programa non será instalado.%n%nPodes voltar a executar o programa de Instalación noutro intre para completa-la mesma.%n%nQueres sair do Instalador?
