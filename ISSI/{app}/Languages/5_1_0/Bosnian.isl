...
OnlyOnTheseArchitectures=Ovaj programse može instalirati samo na verzijama Windowsa napravljenim za sljedeæe arhitekture procesora:%n%n%1
MissingWOW64APIs=Verzija Windowsa koju koristite ne sadrži funkcionalnosti potrebne za instalacijski program da uradi 64-bitnu instalaciju. Da bi ispravili taj problem, molimo instalirajte Service Pack %1.
...
WelcomeLabel2=Ovaj program æe instalirati [name/ver] na vaš raèunar.%n%nPreporuèujemo da zatvorite sve programe prije nastavka.
