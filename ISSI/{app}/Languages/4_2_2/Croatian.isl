...
; *** Inno Setup version 1.3.14 Croatian translation ***
;
; Preveo na hrvatski Vladimir Žderiæ (vladimir.zderic@ci.tel.hr).
;
; *** Inno Setup version 4.2.1+ Croatian translation ***
;  Doradio Krunoslav Kanjuh (krunoslav.kanjuh@zg.htnet.hr)
;
;
;
...
; *** File copying errors
FileAbortRetryIgnore=Kliknite Retry da pokušate ponovo, Ignore da preskoèite ovu datoteku (ne preporuèa se), ili Abort da prekinete instalaciju.
FileAbortRetryIgnore2=Kliknite Retry da pokušate ponovo, Ignore da preskoèite ovu datoteku (ne preporuèa se), ili Abort da prekinete instalaciju.
SourceIsCorrupted=Izvorišna datoteka je ošteæena
SourceDoesntExist=Izvorišna datoteka "%1" ne postoji
ExistingFileReadOnly=Postojeæa datoteka je oznaèena "samo-za-èitanje".%n%nKliknite Retry da uklonite oznaku "samo-za-èitanje" i pokušati ponovo, Ignore da preskoèite ovu datoteku, ili Abort da prekinete instalaciju.
...
AssocingFileExtension=Asociram %1 sa %2 ekstenzijom datoteke
