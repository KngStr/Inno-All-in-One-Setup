...
CreateQuickLaunchIcon=Икона в лентата за &бързо стартиране
ProgramOnTheWeb=%1 в WWW
UninstallProgram=Деинсталиране на %1
LaunchProgram=Стартиране на %1
AssocFileExtension=&Асоцииране на %1 с файловото разширение %2
AssocingFileExtension=Асоцииране на %1 с файловото разширение %2...
