;
;Author: Vincenzo
;Article created: 02/05/03 17:00:12
;Article URL : http://www.vincenzo.net/isxkb/modules.php?name=News&file=article&sid=45
;--------------------------------------------------------------------------------
;Author: Thomas Vedel
;
;Native ISX procedures for PATH modification.
;
;Sample usage:
;  ModifyPath('c:\MyTestDir', pmRemoveSubdirsAlso, psAllUsers);
