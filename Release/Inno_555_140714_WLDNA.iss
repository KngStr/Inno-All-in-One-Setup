...
[Messages]
AboutSetupNote=Inno Setup Preprocessor home page:%nhttp://ispp.sourceforge.net/ %n%n±¾³ÌÐòÓÉ WLDNA ÇãÇéÖÆ×÷£¬»¶Ó­Ê¹ÓÃ%nÎÒµÄ²©¿Í£ºhttp://www.wldna.com/

[Run]
Filename: http://www.wldna.com/; Description: ·ÃÎÊ WLDNA;  Flags: postinstall shellexec skipifsilent

[Icons]
Name: "{group}\·ÃÎÊ WLDNA"; Filename: http://www.wldna.com/; 
...
[Messages]
ChineseSimp.BeveledLabel=WLDNA

ChineseSimp.SetupWindowTitle=WLDNA - %1
ChineseSimp.SetupAppTitle=WLDNA - Inno Setup ¼¯³É°æ(Ô­D8ÍÅ¶Ó°æ)
ChineseSimp.UninstallAppTitle=WLDNA - Ð¶ÔØ
ChineseSimp.UninstallAppFullTitle=WLDNA - %1 Ð¶ÔØ


[CustomMessages]
ChineseSimp.Btn_About_Caption=¹ØÓÚ(&A)
ChineseSimp.Btn_About_Text=WLDNA-×¨×¢ÓÚInno/DelphiºÍNsisÎªÖ÷µÄÈí¼þ·â×°¼¼Êõ£¬ÒÔ¼°¿ìËÙÅúÁ¿µÄÈí¼þ´ò°ü·½°¸¡£
ChineseSimp.Lbl_FinishTip_Caption=·ÃÎÊ WLDNA
ChineseSimp.Lbl_FinishTip_Url=http://www.wldna.com/
ChineseSimp.BevelLabel_Url=http://www.wldna.com/
...
;SkyGz Ansi Ispp
Source: E:\Version\GitHub\Inno-All-in-One-Setup\IsPack_SkyGz\Ansi\*; Excludes: Compil32.*; DestDir: {app}; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList; Components: Inno\Ansi and ISCmplr_Setup\SkyGz; Tasks:
Source: E:\Version\GitHub\Inno-All-in-One-Setup\IsPack_SkyGz\Ansi\Compil32.exe; DestDir: {app}; Flags: ignoreversion; BeforeInstall: AddToDetaList; Components: Inno\Ansi and IDE\SkyGz; Tasks:
;SkyGz Unicode Ispp
Source: E:\Version\GitHub\Inno-All-in-One-Setup\IsPack_SkyGz\Unicode\*; Excludes: Compil32.*; DestDir: {app}; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList; Components: Inno\Unicode and ISCmplr_Setup\SkyGz; Tasks:
Source: E:\Version\GitHub\Inno-All-in-One-Setup\IsPack_SkyGz\Unicode\Compil32.exe; DestDir: {app}; Flags: ignoreversion; BeforeInstall: AddToDetaList; Components: Inno\Unicode and IDE\SkyGz; Tasks:

;SkyGz Examples
Source: E:\Version\GitHub\Inno-All-in-One-Setup\IsPack_SkyGz\Examples\UninstallCodeDll.iss; DestDir: {app}\Examples; Flags: ignoreversion; BeforeInstall: AddToDetaList;
Source: E:\Version\GitHub\Inno-All-in-One-Setup\IsPack_SkyGz\Examples\ExtendExample.iss; DestDir: {app}\Examples\SkyGz; Components: ISCmplr_Setup\SkyGz; Flags: ignoreversion; BeforeInstall: AddToDetaList;
;Help
Source: E:\Version\GitHub\Inno-All-in-One-Setup\IsPack_SkyGz\Help\*; DestDir: {app}; Components: Inno; Languages: ChineseSimp; BeforeInstall: AddToDetaList; Flags: ignoreversion


Source: E:\Version\GitHub\Inno-All-in-One-Setup\IsPack\isfiles\isscint.dll; DestDir: {app}; Flags: ignoreversion replacesameversion; BeforeInstall: AddToDetaList; Components: IDE\SkyGz
...
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\ISSkinU.dll; DestDir: {tmp}; Flags: ignoreversion noencryption nocompression dontcopy
...
[Files]
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\ISWin7.dll; DestDir: {tmp}; Flags: ignoreversion noencryption nocompression dontcopy
...
[Files]
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\ISTask.dll; DestDir: {tmp}; Flags: ignoreversion noencryption nocompression dontcopy
...
[Files]
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\WaterLib.dll; DestDir: {tmp}; Flags: ignoreversion noencryption nocompression dontcopy
...
[Files]
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\winmsgctrl.dll; DestDir: {tmp}; Flags: ignoreversion noencryption nocompression dontcopy
...
[Files]
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\ItDownload.dll; DestDir: {tmp}; Flags: ignoreversion noencryption nocompression dontcopy
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Extensions\ItDownload\languages\*.ini; DestDir: {tmp}; Flags: ignoreversion noencryption nocompression dontcopy
...
[Files]
Source: "E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\trayiconctrl.dll"; DestDir: {tmp}; Flags: ignoreversion noencryption nocompression dontcopy
...
pm_About=&About...
pm_Exit=E&xit
pm_Start=Inno Setup ¼¯³É°æ(Ô­D8ÍÅ¶Ó°æ) 5.5.5Setup is starting...
...
ChineseSimp.pm_Start=Inno Setup ¼¯³É°æ(Ô­D8ÍÅ¶Ó°æ) 5.5.5°²×°³ÌÐò¿ªÊ¼...
...
begin
  ...
  InitTrayIconCtrl(MainForm.Handle, WizardForm.Handle, WM_ICON_NOTIFY, 'Inno Setup ¼¯³É°æ(Ô­D8ÍÅ¶Ó°æ) 5.5.5', 0,
       True, False, MenuStrs, 0, @TrayMenuItemOnClick, @TrayMenuOnPopup, nil);

  ShowBalloon(CustomMessage('pm_Start'), 'Inno Setup ¼¯³É°æ(Ô­D8ÍÅ¶Ó°æ) 5.5.5', 0, 10, False);
end;
...
[Files]
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\IssProc.dll; DestDir: {app}\UninsFiles; Flags: ignoreversion noencryption nocompression
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Include\IssProc\IssProcLanguage.ini; DestDir: {app}\UninsFiles; Flags: ignoreversion noencryption nocompression
...
AppVerName=Inno Setup ¼¯³É°æ(Ô­D8ÍÅ¶Ó°æ) 5.5.5
AppPublisher=WLDNA
AppPublisherURL=http://www.wldna.com/
AppSupportURL=http://www.wldna.com/
...
VersionInfoVersion=2014.7.14.14
;#ifndef Test
...
AllowNoIcons=true
LicenseFile=E:\Version\GitHub\Inno-All-in-One-Setup\IsPack\isfiles\License.txt
OutputDir=.\Release
OutputBaseFilename=Inno_555_140714_WLDNA
UninstallFilesDir={app}\UninsFiles
SetupIconFile=E:\Version\GitHub\Inno-All-in-One-Setup\\Res\Inst.ico
WizardImageFile=E:\Version\GitHub\Inno-All-in-One-Setup\\Res\Left.bmp
WizardSmallImageFile=E:\Version\GitHub\Inno-All-in-One-Setup\\Res\Header.bmp
...
Name: ChineseSimp; MessagesFile: E:\Version\GitHub\Inno-All-in-One-Setup\\Res\Languages\ChineseSimp.isl
Name: ChineseTrad; MessagesFile: E:\Version\GitHub\Inno-All-in-One-Setup\\Res\Languages\ChineseTrad.isl
...
[Components]
Name: Inno; Description: Ö÷³ÌÐò(±ØÐë) - (Inno 5.5.5); Flags: fixed; Types: custom compact full
...
Name: ISCmplr_Setup\SkyGz; Description: SkyGz ±àÒëÆ÷ÔöÇ¿°æ   (5.5.5 Build 140711); Flags: exclusive disablenouninstallwarning;
...
Name: IDE\SkyGz; Description: SkyGz ±à¼­Æ÷ÔöÇ¿°æ  (5.5.5 Build 140711); Flags: exclusive disablenouninstallwarning;
...
[Files]
;ISStudio
Source: E:\Version\GitHub\Inno-All-in-One-Setup\ISStudio\{app}\*; DestDir: {app}\ISStudio; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList; Tasks: ; Components: IDE\ISStudio
Source: E:\Version\GitHub\Inno-All-in-One-Setup\ISStudio\Extra_Languages\*; DestDir: {app}\ISStudio\Languages; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList; Tasks: ; Components: IDE\ISStudio
...
Name: EasySets\EditorSet; Description: WLDNA ÍÆ¼öÉèÖÃ; Types: custom compact full; Flags: disablenouninstallwarning;
...
[Files]
;ISSkin Resouces
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Include\ISSkin.ish; DestDir: {app}\Include; Components: Plugins\IsSkin; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList

Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\ISSkinU.dll; DestDir: {app}\Plugins; Components: Plugins\IsSkin and Inno\Unicode; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\ISSkin.dll; DestDir: {app}\Plugins; Components: Plugins\IsSkin and Inno\Ansi; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\ISSkin\*; DestDir: {app}\Examples\ISSkin; Components: Extensions\IsSkin_Styles; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList; Tasks:
...
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Extensions\ISSkinEx\Styles\Vista.cjstyles; DestDir: {app}\Extensions\ISSkin\Styles; Components: Extensions\IsSkin_Styles; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Extensions\ISSkinEx\Styles\Codejock.cjstyles; DestDir: {app}\Extensions\ISSkin\Styles; Components: Extensions\IsSkin_Styles; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Extensions\ISSkinEx\Styles\ISSkinEx.cjstyles; DestDir: {app}\Extensions\ISSkin\Styles; Components: Extensions\IsSkin_Styles; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Extensions\ISSkinEx\Styles\Office2007.cjstyles; DestDir: {app}\Extensions\ISSkin\Styles; Components: Extensions\IsSkin_Styles; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Extensions\ISSkinEx\Styles\Sakura.cjstyles; DestDir: {app}\Extensions\ISSkin\Styles; Components: Extensions\IsSkin_Styles; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList

;ISTask
    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\ISTask.dll; DestDir: {app}\Plugins\; Components: Plugins\ISTask; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList

    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Include\ISTask.Ish; DestDir: {app}\Include\; Components: Plugins\ISTask; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList

    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\ISTask.Iss; DestDir: {app}\Examples\; Components: Plugins\ISTask; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
  ...
  ;botva2
    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\botva2.dll; DestDir: {app}\Plugins\; Components: Plugins\botva2; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList

    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Include\botva2\*; DestDir: {app}\Include\botva2; Components: Plugins\botva2; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList

    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\botva2\*; DestDir: {app}\Examples\botva2; Components: Plugins\botva2; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
    ...
    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Include\STS.Ish; DestDir: {app}\Include\; Components: Plugins\botva2; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
  ...
  ;ISWin7
    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\ISWin7.dll; DestDir: {app}\Plugins\; Components: Plugins\ISWin7; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList

    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Include\ISWin7.Ish; DestDir: {app}\Include\; Components: Plugins\ISWin7; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList

    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\ISWin7.Iss; DestDir: {app}\Examples\; Components: Plugins\ISWin7; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
  ...
  ;ISFlash
    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\ISFlash.dll; DestDir: {app}\Plugins\; Components: Plugins\ISFlash; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList


    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\ISFlash\*; DestDir: {app}\Examples\ISFlash; Components: Plugins\ISFlash; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
  ...
  ;is7z
    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\is7z.dll; DestDir: {app}\Plugins\; Components: Plugins\is7z; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList


    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\is7z\*; DestDir: {app}\Examples\is7z; Components: Plugins\is7z; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList


    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Docs\is7z\*; DestDir: {app}\Docs\is7z; Components: Plugins\is7z; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\is7z.dll; DestDir: {app}\Plugins\; Components: Plugins\is7z; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
    ...
    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Docs\is7z\*; DestDir: {app}\Docs\is7z; Components: Plugins\is7z; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
  ;IssProc
    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\IssProc.dll; DestDir: {app}\Plugins\; Components: Plugins\IssProc; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList

    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Include\IssProc\*; DestDir: {app}\Include\IssProc; Components: Plugins\IssProc; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList

    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\IssProc\*; DestDir: {app}\Examples\IssProc; Components: Plugins\IssProc; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
  ...
  ;UpdateIcon
    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\UpdateIcon.dll; DestDir: {app}\Plugins\; Components: Plugins\UpdateIcon; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList


    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\UpdateIcon\*; DestDir: {app}\Examples\UpdateIcon; Components: Plugins\UpdateIcon; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
  ...
  ;Isgsg
    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\Isgsg.dll; DestDir: {app}\Plugins\; Components: Plugins\Isgsg; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList

    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Include\Isgsg.Ish; DestDir: {app}\Include\; Components: Plugins\Isgsg; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList

    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\Isgsg\*; DestDir: {app}\Examples\Isgsg; Components: Plugins\Isgsg; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
  ...
  ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;Restools Plugins;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ;CallNsis
    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\CallNsis.dll; DestDir: {app}\Plugins\; Components: Plugins\CallNsis; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList


    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\CallNsis\*; DestDir: {app}\Examples\CallNsis; Components: Plugins\CallNsis; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList



    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Include\Restools\CallNsis.Ish; DestDir: {app}\Include\Restools; Components: Plugins\CallNsis; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList



  Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\Nsis\*; DestDir: {app}\Plugins\Nsis; Components: Plugins\CallNsis; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
  ;WaterCtrl
    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\WaterCtrl.dll; DestDir: {app}\Plugins\; Components: Plugins\WaterCtrl; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList


    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\WaterCtrl\*; DestDir: {app}\Examples\WaterCtrl; Components: Plugins\WaterCtrl; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
  ...
  ;GifCtrl
    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\GifCtrl.dll; DestDir: {app}\Plugins\; Components: Plugins\GifCtrl; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList


    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\GifCtrl\*; DestDir: {app}\Examples\GifCtrl; Components: Plugins\GifCtrl; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList



    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Include\Restools\GifCtrl.Ish; DestDir: {app}\Include\Restools; Components: Plugins\GifCtrl; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList



  ;FireCtrl
    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\FireCtrl.dll; DestDir: {app}\Plugins\; Components: Plugins\FireCtrl; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList


    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\FireCtrl\*; DestDir: {app}\Examples\FireCtrl; Components: Plugins\FireCtrl; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
...
;DesCtrl
    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\DescCtrl.dll; DestDir: {app}\Plugins\; Components: Plugins\DescCtrl; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList


    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\DescCtrl.Iss; DestDir: {app}\Examples\; Components: Plugins\DescCtrl; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList



    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Include\Restools\DescCtrl.Ish; DestDir: {app}\Include\Restools; Components: Plugins\DescCtrl; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList



;TimeCtrl
    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\TimeCtrl.dll; DestDir: {app}\Plugins\; Components: Plugins\TimeCtrl; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList


    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\TimeCtrl\*; DestDir: {app}\Examples\TimeCtrl; Components: Plugins\TimeCtrl; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
...
;CallbackCtrl
    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\CallbackCtrl.dll; DestDir: {app}\Plugins\; Components: Plugins\CallbackCtrl; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList


    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\CallbackCtrl\*; DestDir: {app}\Examples\CallbackCtrl; Components: Plugins\CallbackCtrl; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList



    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Include\Restools\CallbackCtrl.Ish; DestDir: {app}\Include\Restools; Components: Plugins\CallbackCtrl; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
...
;ExecCtrl
;WebCtrl
    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\WebCtrl.dll; DestDir: {app}\Plugins\; Components: Plugins\WebCtrl; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList


    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\WebCtrl\*; DestDir: {app}\Examples\WebCtrl; Components: Plugins\WebCtrl; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList



    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Include\Restools\WebCtrl.Ish; DestDir: {app}\Include\Restools; Components: Plugins\WebCtrl; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList



;TrayIconCtrl
    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\TrayIconCtrl.dll; DestDir: {app}\Plugins\; Components: Plugins\TrayIconCtrl; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList


    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\TrayIconCtrl\*; DestDir: {app}\Examples\TrayIconCtrl; Components: Plugins\TrayIconCtrl; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList



    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Include\Restools\TrayIconCtrl.Ish; DestDir: {app}\Include\Restools; Components: Plugins\TrayIconCtrl; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList



;CpuDesc
    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\CpuDesc.dll; DestDir: {app}\Plugins\; Components: Plugins\CpuDesc; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList


    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\CpuDesc.Iss; DestDir: {app}\Examples\; Components: Plugins\CpuDesc; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
...
;MsgCtrl
    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\winmsgctrl.dll; DestDir: {app}\Plugins\; Components: Plugins\MsgCtrl; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList


    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\MsgCtrl\*; DestDir: {app}\Examples\MsgCtrl; Components: Plugins\MsgCtrl; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList



    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Include\Restools\MsgCtrl.Ish; DestDir: {app}\Include\Restools; Components: Plugins\MsgCtrl; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
...
;ISXDL
    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\ISXDL.dll; DestDir: {app}\Plugins\; Components: Plugins\ISXDL; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList

    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Include\ISXDL.Ish; DestDir: {app}\Include\; Components: Plugins\ISXDL; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList

    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\ISXDL.Iss; DestDir: {app}\Examples\; Components: Plugins\ISXDL; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList


    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Docs\ISXDL\*; DestDir: {app}\Docs\ISXDL; Components: Plugins\ISXDL; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\ISXDL.dll; DestDir: {app}\Plugins\; Components: Plugins\ISXDL; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
    ...
    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Docs\ISXDL\*; DestDir: {app}\Docs\ISXDL; Components: Plugins\ISXDL; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
;ItDownload
    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\ItDownload.dll; DestDir: {app}\Plugins\; Components: Plugins\ItDownload; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList


    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\ItDownload\*; DestDir: {app}\Examples\ItDownload; Components: Plugins\ItDownload; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList

    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Extensions\ItDownload\*; DestDir: {app}\Extensions\ItDownload; Components: Plugins\ItDownload; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList


    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Include\Sherlock\ItDownload.Ish; DestDir: {app}\Include\Sherlock; Components: Plugins\ItDownload; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList



;ItTray
    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\ItTray.dll; DestDir: {app}\Plugins\; Components: Plugins\ItTray; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList


    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\ItTray\*; DestDir: {app}\Examples\ItTray; Components: Plugins\ItTray; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList



    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Include\Sherlock\ItTray.Ish; DestDir: {app}\Include\Sherlock; Components: Plugins\ItTray; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
...
;SkyGz Plugins
;FlashLib
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Include\SkyGz\FlashLib.ish; DestDir: {app}\Include\SkyGz; Components: Plugins\FlashLib; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\FlashLib.dll; DestDir: {app}\Plugins; Components: Plugins\FlashLib; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\SkyGz\FlashLib_Example.iss; DestDir: {app}\Examples\SkyGz; Components: Plugins\FlashLib; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\SkyGz\FlashLib.swf; DestDir: {app}\Examples\SkyGz; Components: Plugins\FlashLib; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
;GifLib
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Include\SkyGz\GifLib.ish; DestDir: {app}\Include\SkyGz; Components: Plugins\GifLib; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\GifLib.dll; DestDir: {app}\Plugins; Components: Plugins\GifLib; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\SkyGz\GifLib_Example.iss; DestDir: {app}\Examples\SkyGz; Components: Plugins\GifLib; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\SkyGz\1139681544755.gif; DestDir: {app}\Examples\SkyGz; Components: Plugins\GifLib; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
;WaterLib
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Include\SkyGz\WaterLib.ish; DestDir: {app}\Include\SkyGz; Components: Plugins\WaterLib; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\WaterLib.dll; DestDir: {app}\Plugins; Components: Plugins\WaterLib; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\SkyGz\WaterLib_Example.iss; DestDir: {app}\Examples\SkyGz; Components: Plugins\WaterLib; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList

  ;InnoCallBack
    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\InnoCallBack.dll; DestDir: {app}\Plugins\; Components: ; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList

    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Include\InnoCallBack.Ish; DestDir: {app}\Include\; Components: ; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList

    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\InnoCallBack.Iss; DestDir: {app}\Examples\; Components: ; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
...
Source: What's new.txt; DestDir: {app}\UninsFiles; Flags: isreadme
    ...
    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\[Ish]\*; DestDir: {app}\Examples\[Ish]; Components: ; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList


    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Docs\[Ish]\*; DestDir: {app}\Docs\[Ish]; Components: ; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
    ...
    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Include\System.Ish; DestDir: {app}\Include\; Components: ; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
    ...
    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Include\Macros.Ish; DestDir: {app}\Include\; Components: ; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
    ...
    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Include\ISPP\InstFiles.Ish; DestDir: {app}\Include\ISPP; Components: ; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList

    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\ISPP\InstFiles\*; DestDir: {app}\Examples\ISPP\InstFiles; Components: ; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList



;Ô¤ÊÍ·ÅÎÄ¼þ
Source: Res\Uninst.ico; Flags: solidbreak dontcopy
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\UpdateIcon.dll; DestDir: {app}\Plugins; Flags: ignoreversion dontcopy; BeforeInstall: AddToDetaList
Source: E:\Version\GitHub\Inno-All-in-One-Setup\\Res\Skins\*; DestDir: {tmp}; Flags: ignoreversion dontcopy; BeforeInstall: AddToDetaList
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Extensions\ISSkinEx\Styles\Codejock.cjstyles; DestDir: {tmp}; Flags: ignoreversion dontcopy; BeforeInstall: AddToDetaList
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Extensions\ISSkinEx\Styles\ISSkinEx.cjstyles; DestDir: {tmp}; Flags: ignoreversion dontcopy; BeforeInstall: AddToDetaList
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Extensions\ISSkinEx\Styles\Sakura.cjstyles; DestDir: {tmp}; Flags: ignoreversion dontcopy; BeforeInstall: AddToDetaList

Source: E:\Version\GitHub\Inno-All-in-One-Setup\IsPack\isfiles\*; Excludes: .git*,cvs\*,ISPP.dll,*.e32,Compil32.exe,isscint.dll,ISPPCC.exe,ISCC.exe,ISCmplr.dll; DestDir: {app}; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList; Components: Inno
Source: E:\Version\GitHub\Inno-All-in-One-Setup\IsPack\Setup.*; DestDir: {app}\Examples; BeforeInstall: AddToDetaList; Components: Inno; Flags: ignoreversion
Source: E:\Version\GitHub\Inno-All-in-One-Setup\IsPack\isfiles\isscint.dll; DestDir: {app}; Flags: ignoreversion replacesameversion; BeforeInstall: AddToDetaList; Components: not IDE\Restools

;Ansi Ispp
Source: E:\Version\GitHub\Inno-All-in-One-Setup\IsPack\isfiles\Compil32.exe; DestDir: {app}; DestName: Compil32.exe; Flags: ignoreversion replacesameversion; BeforeInstall: AddToDetaList; Components: Inno\Ansi and not IDE\Restools
Source: E:\Version\GitHub\Inno-All-in-One-Setup\IsPack\isfiles\ISPP.dll; DestDir: {app}; DestName: ISPP.dll; Flags: ignoreversion replacesameversion; BeforeInstall: AddToDetaList; Components: Inno\Ansi and not ISCmplr_Setup
Source: E:\Version\GitHub\Inno-All-in-One-Setup\IsPack\isfiles\ISPPCC.exe; DestDir: {app}; DestName: ISCC.exe; Flags: ignoreversion replacesameversion; BeforeInstall: AddToDetaList; Components: Inno\Ansi and not ISCmplr_Setup
Source: E:\Version\GitHub\Inno-All-in-One-Setup\IsPack\isfiles\*.e32; DestDir: {app}; Flags: ignoreversion replacesameversion; BeforeInstall: AddToDetaList; Components: Inno\Ansi and not ISCmplr_Setup
Source: E:\Version\GitHub\Inno-All-in-One-Setup\IsPack\isfiles\ISCmplr.dll; DestDir: {app}; Flags: ignoreversion replacesameversion; BeforeInstall: AddToDetaList; Components: Inno\Ansi and not ISCmplr_Setup

;Unicode Ispp
Source: E:\Version\GitHub\Inno-All-in-One-Setup\IsPack\isfiles-unicode\Compil32.exe; DestDir: {app}; DestName: Compil32.exe; Flags: ignoreversion replacesameversion; BeforeInstall: AddToDetaList; Components: Inno\Unicode  and not IDE\Restools
Source: E:\Version\GitHub\Inno-All-in-One-Setup\IsPack\isfiles-unicode\ISPP.dll; DestDir: {app}; DestName: ISPP.dll; Flags: ignoreversion replacesameversion; BeforeInstall: AddToDetaList; Components: Inno\Unicode and not ISCmplr_Setup
Source: E:\Version\GitHub\Inno-All-in-One-Setup\IsPack\isfiles-unicode\ISPPCC.exe; DestDir: {app}; DestName: ISCC.exe; Flags: ignoreversion replacesameversion; BeforeInstall: AddToDetaList; Components: Inno\Unicode and not ISCmplr_Setup
Source: E:\Version\GitHub\Inno-All-in-One-Setup\IsPack\isfiles-unicode\*.e32; DestDir: {app}; Flags: ignoreversion replacesameversion; BeforeInstall: AddToDetaList; Components: Inno\Unicode and not ISCmplr_Setup
Source: E:\Version\GitHub\Inno-All-in-One-Setup\IsPack\isfiles-unicode\ISCmplr.dll; DestDir: {app}; Flags: ignoreversion replacesameversion; BeforeInstall: AddToDetaList; Components: Inno\Unicode and not ISCmplr_Setup

Source: E:\Version\GitHub\Inno-All-in-One-Setup\Docs\Hanzify Forum Inno Article.chm; DestDir: {app}\Docs; Flags: ignoreversion; Components: Help\Hanzify; Tasks:
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Docs\Inno Setup Extensions Knowledge Base.chm; DestDir: {app}\Docs; Flags: ignoreversion; Components: Help\Isxkb; Tasks:
...
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Docs\Inno Setup ISD Format.htm; DestDir: {app}\Docs; Flags: ignoreversion; Components: Help\ISD; Tasks:
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Docs\DelphiKey.htm; DestDir: {app}\Docs; Flags: ignoreversion; Components: Help; Tasks:

;Extensions



    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Extensions\Graphics\*; DestDir: {app}\Extensions\Graphics; Components: ; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
...
;UninsHs
    ...
    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\UninsHs.Iss; DestDir: {app}\Examples\; Components: Extensions\UninsHs; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList

    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Extensions\UninsHs\*; DestDir: {app}\Extensions\UninsHs; Components: Extensions\UninsHs; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
...
;Converter
    ...
    Source: E:\Version\GitHub\Inno-All-in-One-Setup\Extensions\Converter\*; DestDir: {app}\Extensions\Converter; Components: Extensions\Converter; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
...
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Extensions\CodeFont\CourierNewEx.fon; DestDir: {app}\Extensions\CodeFont; Components: EasySets\CodeFont; Flags: onlyifdoesntexist ignoreversion fontisnttruetype; FontInstall: Courier New Ex; BeforeInstall: AddToDetaList
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Extensions\CodeFont\Megatops ProCoder 1.0.fon; DestDir: {app}\Extensions\CodeFont; Components: EasySets\CodeFont; Flags: onlyifdoesntexist ignoreversion fontisnttruetype; FontInstall: Megatops ProCoder 1.0; BeforeInstall: AddToDetaList
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Extensions\CodeFont\Raize.fon; DestDir: {app}\Extensions\CodeFont; Components: EasySets\CodeFont; Flags: onlyifdoesntexist ignoreversion fontisnttruetype; FontInstall: Raize; BeforeInstall: AddToDetaList

;SkyGz Enhanced Unpack Tools
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Extensions\Unpack\innounp.exe; DestDir: {app}\Extensions\Unpack; Flags: ignoreversion touch; Components:  Extensions\Unpack\InnoExp; BeforeInstall: AddToDetaList
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Extensions\Unpack\Languages\*.dll; DestDir: {app}\Extensions\Unpack\Languages; Flags: ignoreversion touch; Components:  Extensions\Unpack\InnoExp; BeforeInstall: AddToDetaList
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Extensions\Unpack\ISUnp.exe; DestDir: {app}\Extensions\Unpack; Components: Extensions\Unpack\InnoExp; BeforeInstall: AddToDetaList; Flags: ignoreversion touch
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Extensions\Unpack\Languages\*.lng; DestDir: {app}\Extensions\Unpack\Languages; Flags: ignoreversion touch; Components: Extensions\Unpack\InnoExp; BeforeInstall: AddToDetaList

Source: E:\Version\GitHub\Inno-All-in-One-Setup\Extensions\Unpack\DisasmGUI.exe; DestDir: {app}\Extensions\Unpack; Components: Extensions\Unpack\Disasm; BeforeInstall: AddToDetaList; Flags: ignoreversion touch
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Extensions\Unpack\Disasm.exe; DestDir: {app}\Extensions\Unpack; Components: Extensions\Unpack\Disasm; BeforeInstall: AddToDetaList; Flags: ignoreversion touch

Source: E:\Version\GitHub\Inno-All-in-One-Setup\Extensions\InnoLogView\*; DestDir: {app}\Extensions\InnoLogView; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList; Components: Extensions\InnoLogView

;Nsis Resouces
Source: E:\Version\GitHub\Inno-All-in-One-Setup\\Nsis\Graphics\Header\*; DestDir: {app}\Extensions\Graphics\Nsis_Header; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList; Components: Nsis\Graphics\Header
Source: E:\Version\GitHub\Inno-All-in-One-Setup\\Nsis\Graphics\Wizard\*; DestDir: {app}\Extensions\Graphics\Nsis_Wizard; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList; Components: Nsis\Graphics\Wizard
Source: E:\Version\GitHub\Inno-All-in-One-Setup\\Nsis\Graphics\Icons\*; DestDir: {app}\Extensions\Graphics\Nsis_Icons; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList; Components: Nsis\Graphics\Icons
;MUIOrangeVistaTheme
Source: E:\Version\GitHub\Inno-All-in-One-Setup\\Nsis\Graphics\MUIOrangeVistaTheme\*; DestDir: {app}\Extensions\Graphics\Nsis_MUIOrangeVistaTheme; Components: Nsis\Graphics\MUIOrangeVistaTheme; Tasks: ; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList
Source: E:\Version\GitHub\Inno-All-in-One-Setup\\Nsis\Graphics\MUIOrangeVistaTheme_CD\*; DestDir: {app}\Extensions\Graphics\Nsis_MUIOrangeVistaTheme_CD; Components: Nsis\Graphics\MUIOrangeVistaTheme_CD; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList

;Examples
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\UI\Install Shield Skins\*; DestDir: {app}\Examples\UI\Install Shield Skins; Tasks: ; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList
...
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\UI\WaitingForm\*; DestDir: {app}\Examples\UI\WaitingForm; Tasks: ; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\Autorun\*; DestDir: {app}\Examples\Autorun; Tasks: ; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList

Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\browse for a machine.iss; DestDir: {app}\Examples; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\SelfDel.iss; DestDir: {app}\Examples; Flags: ignoreversion; BeforeInstall: AddToDetaList
;Mui_Nsis
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Include\MUIs\Mui_Nsis.Ish; DestDir: {app}\Include\MUIs; Components: Nsis; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Include\MUIs\Mui_Nsis_Adv.Ish; DestDir: {app}\Include\MUIs; Components: Nsis; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Examples\UI\Mui_Nsis\*; DestDir: {app}\Examples\UI\Mui_Nsis; Components: Nsis; Tasks: ; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList

Source: E:\Version\GitHub\Inno-All-in-One-Setup\Include\MUIs\AllMove.Ish; DestDir: {app}\Include\MUIs; Flags: ignoreversion; BeforeInstall: AddToDetaList

;Include
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Include\PreDefines.ish; DestDir: {app}\Include; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Include\AnimateWindow.ish; DestDir: {app}\Include; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Include\SHFileOperation.ish; DestDir: {app}\Include; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Include\ExecAndWait.Ish; DestDir: {app}\Include; Flags: ignoreversion; BeforeInstall: AddToDetaList

;Plugin
Source: E:\Version\GitHub\Inno-All-in-One-Setup\Plugins\ISCrypt.dll; DestDir: {app}; Flags: ignoreversion; BeforeInstall: AddToDetaList
;Languages
Source: E:\Version\GitHub\Inno-All-in-One-Setup\\Res\Languages\*; DestDir: {app}\Languages; Components: ; Tasks: ; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList
...
begin
  ...
  begin
    ...
    if CompareVersion(Ver, '2014.7.14.14') > 0 then  //ÓÐ¸üÐÂ
    begin
...
if not WizardForm.WelcomePage.Visible then
  ...
  begin
    ShowBalloon(As_Tips[Random(GetArrayLength(As_Tips))], 'Inno Setup ¼¯³É°æ(Ô­D8ÍÅ¶Ó°æ) 5.5.5', 0, 10, False);
  end;
end;
