...
[Files]
Source: E:\Version\Inno\Inno-All-in-One-Setup\\IsPack_5_5_2\isfiles\*; Excludes: .git*,cvs\*,ISPP.dll,*.e32,Compil32.exe,isscint.dll,ISPPCC.exe,ISCC.exe,ISCmplr.dll; DestDir: {app}; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList; Components: ISCmplr_Setup\Restools_MiniVCL or ISCmplr_Setup\Restools_FullVCL

;Languages
Source: E:\Version\Inno\Inno-All-in-One-Setup\\IsPack_5_5_2\Languages\*; DestDir: {app}\Languages; Components: ISCmplr_Setup\Restools_MiniVCL or ISCmplr_Setup\Restools_FullVCL; Tasks: ; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList

;Restools ReadMe
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack_Restools\Inno_ISCmplr_Setup\*; DestDir: {app}\Docs\Restools ISCmplr; Flags: ignoreversion; BeforeInstall: AddToDetaList; Tasks: ; Components: ISCmplr_Setup
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack_Restools\Inno_ISCmplr_Setup\Example\*; DestDir: {app}\Examples\Restools; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList; Tasks: ; Components: ISCmplr_Setup

;Restools Ansi FullVcl
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack_Restools\Inno_ISCmplr_Setup\InnoSetup_ANSI\FullVCL\*; DestDir: {app}; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList; Components: Inno\Ansi and ISCmplr_Setup\Restools_FullVcl; Tasks:
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack_Restools\Inno_ISCmplr_Setup\Example_FullVCL\*; DestDir: {app}\Examples\Restools FullVCL; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList; Components: Inno\Ansi and ISCmplr_Setup\Restools_FullVcl; Tasks:
;Restools Ansi MiniVcl
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack_Restools\Inno_ISCmplr_Setup\InnoSetup_ANSI\MiniVcl\*; DestDir: {app}; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList; Components: Inno\Ansi and ISCmplr_Setup\Restools_MiniVcl; Tasks:
;Restools Enhance Ansi Compiler
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack_Restools\InnoCompiler\ANSI\*; DestDir: {app}; Excludes: Templates.dat; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList; Components: Inno\Ansi and IDE\Restools; Tasks:
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack_Restools\InnoCompiler\ANSI\Templates.dat; DestDir: {app}; Components: Inno\Ansi and IDE\Restools; Tasks:; Flags: confirmoverwrite ignoreversion promptifolder; BeforeInstall: AddToDetaList

;Restools Unicode FullVcl
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack_Restools\Inno_ISCmplr_Setup\InnoSetup_Unicode\FullVCL\*; DestDir: {app}; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList; Components: Inno\Unicode and ISCmplr_Setup\Restools_FullVcl; Tasks:
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack_Restools\Inno_ISCmplr_Setup\Example_FullVCL\*; DestDir: {app}\Examples\Restools FullVCL; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList; Components: Inno\Unicode and ISCmplr_Setup\Restools_FullVcl; Tasks:
;Restools Unicode MiniVcl
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack_Restools\Inno_ISCmplr_Setup\InnoSetup_Unicode\MiniVcl\*; DestDir: {app}; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList; Components: Inno\Unicode and ISCmplr_Setup\Restools_MiniVcl; Tasks:
;Restools Enhance Unicode Compiler
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack_Restools\InnoCompiler\Unicode\*; DestDir: {app}; Excludes: Templates.dat; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList; Components: Inno\Unicode and IDE\Restools; Tasks:
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack_Restools\InnoCompiler\Unicode\Templates.dat; DestDir: {app}; Components: Inno\Unicode and IDE\Restools; Tasks:; Flags: confirmoverwrite ignoreversion promptifolder; BeforeInstall: AddToDetaList

;Restools Enhance Compiler Info
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack_Restools\InnoCompiler\Example\*; DestDir: {app}\Examples; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList; Tasks: ; Components: IDE\Restools
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack_Restools\InnoCompiler\*; Excludes: ANSI\*,Unicode\*,Example\*; DestDir: {app}\Docs\Restools Compiler; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList; Tasks: ; Components: IDE\Restools
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack_Restools\Inno_ISCmplr_Setup\license.txt; DestDir: {app}; Components: Inno; Languages: ChineseSimp; BeforeInstall: AddToDetaList; Flags: ignoreversion
...
;SkyGz Ansi Ispp
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack_SkyGz\Ansi\*; Excludes: Compil32.*; DestDir: {app}; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList; Components: Inno\Ansi and ISCmplr_Setup\SkyGz; Tasks:
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack_SkyGz\Ansi\Compil32.exe; DestDir: {app}; Flags: ignoreversion; BeforeInstall: AddToDetaList; Components: Inno\Ansi and IDE\SkyGz; Tasks:
;SkyGz Unicode Ispp
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack_SkyGz\Unicode\*; Excludes: Compil32.*; DestDir: {app}; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList; Components: Inno\Unicode and ISCmplr_Setup\SkyGz; Tasks:
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack_SkyGz\Unicode\Compil32.exe; DestDir: {app}; Flags: ignoreversion; BeforeInstall: AddToDetaList; Components: Inno\Unicode and IDE\SkyGz; Tasks:

;SkyGz Examples
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack_SkyGz\Examples\UninstallCodeDll.iss; DestDir: {app}\Examples; Flags: ignoreversion; BeforeInstall: AddToDetaList;
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack_SkyGz\Examples\ExtendExample.iss; DestDir: {app}\Examples\SkyGz; Components: ISCmplr_Setup\SkyGz; Flags: ignoreversion; BeforeInstall: AddToDetaList;
;Help
...
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack_SkyGz\Help\IsExtend.chm; DestDir: {app}; Components: ISCmplr_Setup\SkyGz; Languages: ChineseSimp; BeforeInstall: AddToDetaList; Flags: ignoreversion


Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack\isfiles\isscint.dll; DestDir: {app}; Flags: ignoreversion replacesameversion; BeforeInstall: AddToDetaList; Components: IDE\SkyGz
...
[Files]
;KngStr Ansi Ispp
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack_KngStr\Ansi\*; Excludes: Compil32.*,ISCC.exe; DestDir: {app}; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList; Components: Inno\Ansi and ISCmplr_Setup\KngStr; Tasks:
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack_KngStr\Ansi\ISCC.exe; DestDir: {app}; Flags: ignoreversion; BeforeInstall: AddToDetaList; Components: Inno\Ansi and ISCC\KngStr; Tasks:
;KngStr Unicode Ispp
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack_KngStr\Unicode\*; Excludes: Compil32.*,ISCC.exe; DestDir: {app}; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList; Components: Inno\Unicode and ISCmplr_Setup\KngStr; Tasks:
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack_KngStr\Unicode\ISCC.exe; DestDir: {app}; Flags: ignoreversion; BeforeInstall: AddToDetaList; Components: Inno\Unicode and ISCC\KngStr; Tasks:
...
Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\ISSkinU.dll; DestDir: {tmp}; Flags: ignoreversion noencryption nocompression dontcopy
...
[Files]
Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\ISWin7.dll; DestDir: {tmp}; Flags: ignoreversion noencryption nocompression dontcopy
...
[Files]
Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\ISTask.dll; DestDir: {tmp}; Flags: ignoreversion noencryption nocompression dontcopy
...
[Files]
Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\WaterLib.dll; DestDir: {tmp}; Flags: ignoreversion noencryption nocompression dontcopy
...
[Files]
Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\winmsgctrl.dll; DestDir: {tmp}; Flags: ignoreversion noencryption nocompression dontcopy
...
[Files]
Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\ItDownload.dll; DestDir: {tmp}; Flags: ignoreversion noencryption nocompression dontcopy
Source: E:\Version\Inno\Inno-All-in-One-Setup\Extensions\ItDownload\languages\*.ini; DestDir: {tmp}; Flags: ignoreversion noencryption nocompression dontcopy
...
[Files]
Source: "E:\Version\Inno\Inno-All-in-One-Setup\Plugins\trayiconctrl.dll"; DestDir: {tmp}; Flags: ignoreversion noencryption nocompression dontcopy
...
pm_About=&About...
pm_Exit=E&xit
pm_Start=Inno Setup ¼¯³É°æ 5.6.1Setup is starting...
...
ChineseSimp.pm_Start=Inno Setup ¼¯³É°æ 5.6.1°²×°³ÌÐò¿ªÊ¼...
...
begin
  ...
  InitTrayIconCtrl(MainForm.Handle, WizardForm.Handle, WM_ICON_NOTIFY, 'Inno Setup ¼¯³É°æ 5.6.1', 0,
       True, False, MenuStrs, 0, @TrayMenuItemOnClick, @TrayMenuOnPopup, nil);

  ShowBalloon(CustomMessage('pm_Start'), 'Inno Setup ¼¯³É°æ 5.6.1', 0, 10, False);
end;
...
[Files]
Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\IssProc.dll; DestDir: {app}\UninsFiles; Flags: ignoreversion noencryption nocompression
Source: E:\Version\Inno\Inno-All-in-One-Setup\Include\IssProc\IssProcLanguage.ini; DestDir: {app}\UninsFiles; Flags: ignoreversion noencryption nocompression
...
AppVerName=Inno Setup ¼¯³É°æ 5.6.1
AppPublisher=KngStr
...
VersionInfoVersion=2021.2.17.11
;#ifndef Test
...
AllowNoIcons=true
LicenseFile=E:\Version\Inno\Inno-All-in-One-Setup\IsPack\isfiles\License.txt
OutputDir=.\Release
OutputBaseFilename=Inno_561_210217_KngStr
UninstallFilesDir={app}\UninsFiles
SetupIconFile=E:\Version\Inno\Inno-All-in-One-Setup\\Res\Inst.ico
WizardImageFile=E:\Version\Inno\Inno-All-in-One-Setup\\Res\Left.bmp
WizardSmallImageFile=E:\Version\Inno\Inno-All-in-One-Setup\\Res\Header.bmp
...
Name: ChineseSimp; MessagesFile: E:\Version\Inno\Inno-All-in-One-Setup\\Res\Languages\ChineseSimp.isl
Name: ChineseTrad; MessagesFile: E:\Version\Inno\Inno-All-in-One-Setup\\Res\Languages\ChineseTrad.isl
...
[Components]
Name: Inno; Description: Ö÷³ÌÐò(±ØÐë) - (Inno 5.6.1); Flags: fixed; Types: custom compact full
...
Name: ISCmplr_Setup\Restools_MiniVCL; Description: Restools Mini VCL    (5.5.1.e2 Build 200415); Flags: exclusive disablenouninstallwarning;
Name: ISCmplr_Setup\Restools_FullVCL; Description: Restools Full VCL    (5.5.1.ee2 Build 200415); Flags: exclusive disablenouninstallwarning;
Name: ISCmplr_Setup\SkyGz; Description: SkyGz ±àÒëÆ÷ÔöÇ¿°æ   (5.6.1 Build 181015); Flags: exclusive disablenouninstallwarning;
Name: ISCmplr_Setup\KngStr; Description: KngStr ±àÒëÆ÷ÔöÇ¿°æ   (5.6.1 Build 210217); Flags: exclusive disablenouninstallwarning;
...
Name: IDE\Restools; Description: Restools ±à¼­Æ÷ÔöÇ¿°æ (5.5.2.0 Build 121215); Flags: exclusive disablenouninstallwarning; Types: custom compact full
Name: IDE\SkyGz; Description: SkyGz ±à¼­Æ÷ÔöÇ¿°æ  (5.6.1 Build 181015); Flags: exclusive disablenouninstallwarning;
...
[Components]
Name: IDE\ISStudio; Description: Inno Script Studio     (2.3.0.0 Build 180430); Types: full compact custom

[Files]
;ISStudio
Source: E:\Version\Inno\Inno-All-in-One-Setup\ISStudio\{app}\*; DestDir: {app}\ISStudio; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList; Tasks: ; Components: IDE\ISStudio
Source: E:\Version\Inno\Inno-All-in-One-Setup\ISStudio\Extra_Languages\*; DestDir: {app}\ISStudio\Languages; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList; Tasks: ; Components: IDE\ISStudio
...
Name: ISCC\KngStr; Description: KngStr Command-Line Compiler (5.6.1 Build 210217); Flags: exclusive disablenouninstallwarning;
...
Name: Extensions\IsSkin_SkinBuilder; Description: IsSkin Æ¤·ô±à¼­Æ÷   (13.2.0.0 Build 090904); Types: full
Name: Extensions\UninsHs; Description: UninsHs Ð¶ÔØÔöÇ¿   (2.1.0.283 Build 080920); Types: full compact
Name: Extensions\Converter; Description: Converter {cm:Converter}  (cntrump ºº»¯)   (0.1.4.0 Build 101029); Types: full compact
...
Name: Extensions\InnoLogView; Description: InnoLogView {cm:InnoLogView}   (1.0.0.0 Build 100520); Types: custom full
...
[Files]
;ISSkin Resouces
Source: E:\Version\Inno\Inno-All-in-One-Setup\Include\ISSkin.ish; DestDir: {app}\Include; Components: Plugins\IsSkin; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList

Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\ISSkinU.dll; DestDir: {app}\Plugins; Components: Plugins\IsSkin and Inno\Unicode; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\ISSkin.dll; DestDir: {app}\Plugins; Components: Plugins\IsSkin and Inno\Ansi; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\ISSkin\*; DestDir: {app}\Examples\ISSkin; Components: Extensions\IsSkin_Styles; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList; Tasks:
Source: E:\Version\Inno\Inno-All-in-One-Setup\Extensions\ISSkin\SkinBuilder.exe; DestDir: {app}\Extensions\ISSkin; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList; Components: Extensions\IsSkin_SkinBuilder
Source: E:\Version\Inno\Inno-All-in-One-Setup\Extensions\ISSkin\ISSkinViewer.exe; DestDir: {app}\Extensions\ISSkin; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList; Components: Extensions\IsSkin_SkinBuilder
Source: E:\Version\Inno\Inno-All-in-One-Setup\Extensions\ISSkin\ISSkinViewer.iss; DestDir: {app}\Extensions\ISSkin; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList; Components: Extensions\IsSkin_SkinBuilder

;ISSkinEx Resouces
Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\ISSkinExU.dll; DestDir: {app}\Plugins; DestName: ISSkin.dll; Components: Plugins\IsSkin and Inno\Unicode and (ISCmplr_Setup\Restools_MiniVcl or ISCmplr_Setup\Restools_FullVcl); Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\ISSkinEx.dll; DestDir: {app}\Plugins; DestName: ISSkinU.dll; Components: Plugins\IsSkin and Inno\Ansi and (ISCmplr_Setup\Restools_MiniVcl or ISCmplr_Setup\Restools_FullVcl); Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\Inno\Inno-All-in-One-Setup\Extensions\ISSkinEx\ISSkinViewer.*; DestDir: {app}\Extensions\ISSkin; Components: Extensions\IsSkin_Styles and (ISCmplr_Setup\Restools_MiniVcl or ISCmplr_Setup\Restools_FullVcl); Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\Inno\Inno-All-in-One-Setup\Extensions\ISSkinEx\License.txt; DestDir: {app}\Extensions\ISSkin; DestName: ISSkinEx_License.txt; Components: Extensions\IsSkin_Styles and (ISCmplr_Setup\Restools_MiniVcl or ISCmplr_Setup\Restools_FullVcl); Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
;ISSkin Styles
...
Source: E:\Version\Inno\Inno-All-in-One-Setup\Extensions\ISSkinEx\Styles\Vista.cjstyles; DestDir: {app}\Extensions\ISSkin\Styles; Components: Extensions\IsSkin_Styles; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\Inno\Inno-All-in-One-Setup\Extensions\ISSkinEx\Styles\Codejock.cjstyles; DestDir: {app}\Extensions\ISSkin\Styles; Components: Extensions\IsSkin_Styles; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\Inno\Inno-All-in-One-Setup\Extensions\ISSkinEx\Styles\ISSkinEx.cjstyles; DestDir: {app}\Extensions\ISSkin\Styles; Components: Extensions\IsSkin_Styles; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\Inno\Inno-All-in-One-Setup\Extensions\ISSkinEx\Styles\Office2007.cjstyles; DestDir: {app}\Extensions\ISSkin\Styles; Components: Extensions\IsSkin_Styles; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\Inno\Inno-All-in-One-Setup\Extensions\ISSkinEx\Styles\Sakura.cjstyles; DestDir: {app}\Extensions\ISSkin\Styles; Components: Extensions\IsSkin_Styles; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList

;ISTask
    Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\ISTask.dll; DestDir: {app}\Plugins\; Components: Plugins\ISTask; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList

    Source: E:\Version\Inno\Inno-All-in-One-Setup\Include\ISTask.Ish; DestDir: {app}\Include\; Components: Plugins\ISTask; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList

    Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\ISTask.Iss; DestDir: {app}\Examples\; Components: Plugins\ISTask; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
  ...
  ;botva2
    Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\botva2.dll; DestDir: {app}\Plugins\; Components: Plugins\botva2; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList

    Source: E:\Version\Inno\Inno-All-in-One-Setup\Include\botva2\*; DestDir: {app}\Include\botva2; Components: Plugins\botva2; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList

    Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\botva2\*; DestDir: {app}\Examples\botva2; Components: Plugins\botva2; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
    ...
    Source: E:\Version\Inno\Inno-All-in-One-Setup\Include\STS.Ish; DestDir: {app}\Include\; Components: Plugins\botva2; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
  ...
  ;ISWin7
    Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\ISWin7.dll; DestDir: {app}\Plugins\; Components: Plugins\ISWin7; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList

    Source: E:\Version\Inno\Inno-All-in-One-Setup\Include\ISWin7.Ish; DestDir: {app}\Include\; Components: Plugins\ISWin7; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList

    Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\ISWin7.Iss; DestDir: {app}\Examples\; Components: Plugins\ISWin7; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
  ...
  ;ISFlash
    Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\ISFlash.dll; DestDir: {app}\Plugins\; Components: Plugins\ISFlash; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList


    Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\ISFlash\*; DestDir: {app}\Examples\ISFlash; Components: Plugins\ISFlash; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
  ...
  ;is7z
    Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\is7z.dll; DestDir: {app}\Plugins\; Components: Plugins\is7z; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList


    Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\is7z\*; DestDir: {app}\Examples\is7z; Components: Plugins\is7z; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList


    Source: E:\Version\Inno\Inno-All-in-One-Setup\Docs\is7z\*; DestDir: {app}\Docs\is7z; Components: Plugins\is7z; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
    Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\is7z.dll; DestDir: {app}\Plugins\; Components: Plugins\is7z; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
    ...
    Source: E:\Version\Inno\Inno-All-in-One-Setup\Docs\is7z\*; DestDir: {app}\Docs\is7z; Components: Plugins\is7z; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
  ;IssProc
    Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\IssProc.dll; DestDir: {app}\Plugins\; Components: Plugins\IssProc; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList

    Source: E:\Version\Inno\Inno-All-in-One-Setup\Include\IssProc\*; DestDir: {app}\Include\IssProc; Components: Plugins\IssProc; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList

    Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\IssProc\*; DestDir: {app}\Examples\IssProc; Components: Plugins\IssProc; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
  ...
  ;UpdateIcon
    Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\UpdateIcon.dll; DestDir: {app}\Plugins\; Components: Plugins\UpdateIcon; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList


    Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\UpdateIcon\*; DestDir: {app}\Examples\UpdateIcon; Components: Plugins\UpdateIcon; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
  ...
  ;Isgsg
    Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\Isgsg.dll; DestDir: {app}\Plugins\; Components: Plugins\Isgsg; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList

    Source: E:\Version\Inno\Inno-All-in-One-Setup\Include\Isgsg.Ish; DestDir: {app}\Include\; Components: Plugins\Isgsg; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList

    Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\Isgsg\*; DestDir: {app}\Examples\Isgsg; Components: Plugins\Isgsg; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
  ...
  ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;Restools Plugins;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ;CallNsis
    Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\CallNsis.dll; DestDir: {app}\Plugins\; Components: Plugins\CallNsis; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList


    Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\CallNsis\*; DestDir: {app}\Examples\CallNsis; Components: Plugins\CallNsis; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList



    Source: E:\Version\Inno\Inno-All-in-One-Setup\Include\Restools\CallNsis.Ish; DestDir: {app}\Include\Restools; Components: Plugins\CallNsis; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList



  ;ksiCallNsis
    Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\ksiCallNsis.dll; DestDir: {app}\Plugins\; Components: Plugins\ksiCallNsis; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList

    Source: E:\Version\Inno\Inno-All-in-One-Setup\Include\ksiCallNsis.Ish; DestDir: {app}\Include\; Components: Plugins\ksiCallNsis; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList

    Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\ksiCallNsis\*; DestDir: {app}\Examples\ksiCallNsis; Components: Plugins\ksiCallNsis; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
  ...
  Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\Nsis\*; DestDir: {app}\Plugins\Nsis; Components: Plugins\CallNsis or Plugins\ksiCallNsis; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
  ;WaterCtrl
    Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\WaterCtrl.dll; DestDir: {app}\Plugins\; Components: Plugins\WaterCtrl; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList


    Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\WaterCtrl\*; DestDir: {app}\Examples\WaterCtrl; Components: Plugins\WaterCtrl; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
  ...
  ;GifCtrl
    Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\GifCtrl.dll; DestDir: {app}\Plugins\; Components: Plugins\GifCtrl; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList


    Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\GifCtrl\*; DestDir: {app}\Examples\GifCtrl; Components: Plugins\GifCtrl; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList



    Source: E:\Version\Inno\Inno-All-in-One-Setup\Include\Restools\GifCtrl.Ish; DestDir: {app}\Include\Restools; Components: Plugins\GifCtrl; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList



  ;FireCtrl
    Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\FireCtrl.dll; DestDir: {app}\Plugins\; Components: Plugins\FireCtrl; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList


    Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\FireCtrl\*; DestDir: {app}\Examples\FireCtrl; Components: Plugins\FireCtrl; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
...
;DesCtrl
    Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\DescCtrl.dll; DestDir: {app}\Plugins\; Components: Plugins\DescCtrl; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList


    Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\DescCtrl.Iss; DestDir: {app}\Examples\; Components: Plugins\DescCtrl; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList



    Source: E:\Version\Inno\Inno-All-in-One-Setup\Include\Restools\DescCtrl.Ish; DestDir: {app}\Include\Restools; Components: Plugins\DescCtrl; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList



;TimeCtrl
    Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\TimeCtrl.dll; DestDir: {app}\Plugins\; Components: Plugins\TimeCtrl; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList


    Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\TimeCtrl\*; DestDir: {app}\Examples\TimeCtrl; Components: Plugins\TimeCtrl; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
...
;CallbackCtrl
    Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\CallbackCtrl.dll; DestDir: {app}\Plugins\; Components: Plugins\CallbackCtrl; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList


    Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\CallbackCtrl\*; DestDir: {app}\Examples\CallbackCtrl; Components: Plugins\CallbackCtrl; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList



    Source: E:\Version\Inno\Inno-All-in-One-Setup\Include\Restools\CallbackCtrl.Ish; DestDir: {app}\Include\Restools; Components: Plugins\CallbackCtrl; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
...
;ExecCtrl
;WebCtrl
    Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\WebCtrl.dll; DestDir: {app}\Plugins\; Components: Plugins\WebCtrl; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList


    Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\WebCtrl\*; DestDir: {app}\Examples\WebCtrl; Components: Plugins\WebCtrl; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList



    Source: E:\Version\Inno\Inno-All-in-One-Setup\Include\Restools\WebCtrl.Ish; DestDir: {app}\Include\Restools; Components: Plugins\WebCtrl; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList



;TrayIconCtrl
    Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\TrayIconCtrl.dll; DestDir: {app}\Plugins\; Components: Plugins\TrayIconCtrl; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList


    Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\TrayIconCtrl\*; DestDir: {app}\Examples\TrayIconCtrl; Components: Plugins\TrayIconCtrl; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList



    Source: E:\Version\Inno\Inno-All-in-One-Setup\Include\Restools\TrayIconCtrl.Ish; DestDir: {app}\Include\Restools; Components: Plugins\TrayIconCtrl; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList



;CpuDesc
    Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\CpuDesc.dll; DestDir: {app}\Plugins\; Components: Plugins\CpuDesc; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList


    Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\CpuDesc.Iss; DestDir: {app}\Examples\; Components: Plugins\CpuDesc; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
...
;MsgCtrl
    Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\winmsgctrl.dll; DestDir: {app}\Plugins\; Components: Plugins\MsgCtrl; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList


    Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\MsgCtrl\*; DestDir: {app}\Examples\MsgCtrl; Components: Plugins\MsgCtrl; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList



    Source: E:\Version\Inno\Inno-All-in-One-Setup\Include\Restools\MsgCtrl.Ish; DestDir: {app}\Include\Restools; Components: Plugins\MsgCtrl; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
...
;ISXDL
    Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\ISXDL.dll; DestDir: {app}\Plugins\; Components: Plugins\ISXDL; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList

    Source: E:\Version\Inno\Inno-All-in-One-Setup\Include\ISXDL.Ish; DestDir: {app}\Include\; Components: Plugins\ISXDL; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList

    Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\ISXDL.Iss; DestDir: {app}\Examples\; Components: Plugins\ISXDL; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList


    Source: E:\Version\Inno\Inno-All-in-One-Setup\Docs\ISXDL\*; DestDir: {app}\Docs\ISXDL; Components: Plugins\ISXDL; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
    Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\ISXDL.dll; DestDir: {app}\Plugins\; Components: Plugins\ISXDL; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
    ...
    Source: E:\Version\Inno\Inno-All-in-One-Setup\Docs\ISXDL\*; DestDir: {app}\Docs\ISXDL; Components: Plugins\ISXDL; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
;ItDownload
    Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\ItDownload.dll; DestDir: {app}\Plugins\; Components: Plugins\ItDownload; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList


    Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\ItDownload\*; DestDir: {app}\Examples\ItDownload; Components: Plugins\ItDownload; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList

    Source: E:\Version\Inno\Inno-All-in-One-Setup\Extensions\ItDownload\*; DestDir: {app}\Extensions\ItDownload; Components: Plugins\ItDownload; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList


    Source: E:\Version\Inno\Inno-All-in-One-Setup\Include\Sherlock\ItDownload.Ish; DestDir: {app}\Include\Sherlock; Components: Plugins\ItDownload; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList



;ItTray
    Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\ItTray.dll; DestDir: {app}\Plugins\; Components: Plugins\ItTray; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList


    Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\ItTray\*; DestDir: {app}\Examples\ItTray; Components: Plugins\ItTray; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList



    Source: E:\Version\Inno\Inno-All-in-One-Setup\Include\Sherlock\ItTray.Ish; DestDir: {app}\Include\Sherlock; Components: Plugins\ItTray; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
...
;SkyGz Plugins
;FlashLib
Source: E:\Version\Inno\Inno-All-in-One-Setup\Include\SkyGz\FlashLib.ish; DestDir: {app}\Include\SkyGz; Components: Plugins\FlashLib; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\FlashLib.dll; DestDir: {app}\Plugins; Components: Plugins\FlashLib; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\SkyGz\FlashLib_Example.iss; DestDir: {app}\Examples\SkyGz; Components: Plugins\FlashLib; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\SkyGz\FlashLib.swf; DestDir: {app}\Examples\SkyGz; Components: Plugins\FlashLib; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
;GifLib
Source: E:\Version\Inno\Inno-All-in-One-Setup\Include\SkyGz\GifLib.ish; DestDir: {app}\Include\SkyGz; Components: Plugins\GifLib; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\GifLib.dll; DestDir: {app}\Plugins; Components: Plugins\GifLib; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\SkyGz\GifLib_Example.iss; DestDir: {app}\Examples\SkyGz; Components: Plugins\GifLib; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\SkyGz\1139681544755.gif; DestDir: {app}\Examples\SkyGz; Components: Plugins\GifLib; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
;WaterLib
Source: E:\Version\Inno\Inno-All-in-One-Setup\Include\SkyGz\WaterLib.ish; DestDir: {app}\Include\SkyGz; Components: Plugins\WaterLib; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\WaterLib.dll; DestDir: {app}\Plugins; Components: Plugins\WaterLib; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\SkyGz\WaterLib_Example.iss; DestDir: {app}\Examples\SkyGz; Components: Plugins\WaterLib; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList

  ;InnoCallBack
    Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\InnoCallBack.dll; DestDir: {app}\Plugins\; Components: ; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList

    Source: E:\Version\Inno\Inno-All-in-One-Setup\Include\InnoCallBack.Ish; DestDir: {app}\Include\; Components: ; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList

    Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\InnoCallBack.Iss; DestDir: {app}\Examples\; Components: ; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
...
Source: What's new.txt; DestDir: {app}\UninsFiles; Flags: isreadme
    ...
    Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\[Ish]\*; DestDir: {app}\Examples\[Ish]; Components: ; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList


    Source: E:\Version\Inno\Inno-All-in-One-Setup\Docs\[Ish]\*; DestDir: {app}\Docs\[Ish]; Components: ; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
    ...
    Source: E:\Version\Inno\Inno-All-in-One-Setup\Include\System.Ish; DestDir: {app}\Include\; Components: ; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
    ...
    Source: E:\Version\Inno\Inno-All-in-One-Setup\Include\Macros.Ish; DestDir: {app}\Include\; Components: ; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
    ...
    Source: E:\Version\Inno\Inno-All-in-One-Setup\Include\Isxkb\*; DestDir: {app}\Include\Isxkb; Components: ; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList

    Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\Isxkb\*; DestDir: {app}\Examples\Isxkb; Components: ; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
    ...
    Source: E:\Version\Inno\Inno-All-in-One-Setup\Include\ISPP\InstFiles.Ish; DestDir: {app}\Include\ISPP; Components: ; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList

    Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\ISPP\InstFiles\*; DestDir: {app}\Examples\ISPP\InstFiles; Components: ; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList



;Ô¤ÊÍ·ÅÎÄ¼þ
Source: Res\Uninst.ico; Flags: solidbreak dontcopy
Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\UpdateIcon.dll; DestDir: {app}\Plugins; Flags: ignoreversion dontcopy; BeforeInstall: AddToDetaList
Source: E:\Version\Inno\Inno-All-in-One-Setup\\Res\Skins\*; DestDir: {tmp}; Flags: ignoreversion dontcopy; BeforeInstall: AddToDetaList
Source: E:\Version\Inno\Inno-All-in-One-Setup\Extensions\ISSkinEx\Styles\Codejock.cjstyles; DestDir: {tmp}; Flags: ignoreversion dontcopy; BeforeInstall: AddToDetaList
Source: E:\Version\Inno\Inno-All-in-One-Setup\Extensions\ISSkinEx\Styles\ISSkinEx.cjstyles; DestDir: {tmp}; Flags: ignoreversion dontcopy; BeforeInstall: AddToDetaList
Source: E:\Version\Inno\Inno-All-in-One-Setup\Extensions\ISSkinEx\Styles\Sakura.cjstyles; DestDir: {tmp}; Flags: ignoreversion dontcopy; BeforeInstall: AddToDetaList

Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack\isfiles\*; Excludes: .git*,cvs\*,ISPP.dll,*.e32,Compil32.exe,isscint.dll,ISPPCC.exe,ISCC.exe,ISCmplr.dll; DestDir: {app}; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList; Components: Inno  and not (ISCmplr_Setup\Restools_MiniVCL or ISCmplr_Setup\Restools_FullVCL)
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack\Setup.*; DestDir: {app}\Examples; BeforeInstall: AddToDetaList; Components: Inno; Flags: ignoreversion
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack\isfiles\isscint.dll; DestDir: {app}; Flags: ignoreversion replacesameversion; BeforeInstall: AddToDetaList; Components: IDE\Compile

;Ansi Ispp
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack\isfiles\Compil32.exe; DestDir: {app}; DestName: Compil32.exe; Flags: ignoreversion replacesameversion; BeforeInstall: AddToDetaList; Components: Inno\Ansi and IDE\Compile
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack\isfiles\ISPP.dll; DestDir: {app}; DestName: ISPP.dll; Flags: ignoreversion replacesameversion; BeforeInstall: AddToDetaList; Components: Inno\Ansi and not ISCmplr_Setup
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack\isfiles\ISCC.exe; DestDir: {app}; DestName: ISCC.exe; Flags: ignoreversion replacesameversion; BeforeInstall: AddToDetaList; Components: Inno\Ansi and not ISCmplr_Setup
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack\isfiles\*.e32; DestDir: {app}; Flags: ignoreversion replacesameversion; BeforeInstall: AddToDetaList; Components: Inno\Ansi and not ISCmplr_Setup
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack\isfiles\ISCmplr.dll; DestDir: {app}; Flags: ignoreversion replacesameversion; BeforeInstall: AddToDetaList; Components: Inno\Ansi and not ISCmplr_Setup

;Unicode Ispp
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack\isfiles-unicode\Compil32.exe; DestDir: {app}; DestName: Compil32.exe; Flags: ignoreversion replacesameversion; BeforeInstall: AddToDetaList; Components: Inno\Unicode  and IDE\Compile
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack\isfiles-unicode\ISPP.dll; DestDir: {app}; DestName: ISPP.dll; Flags: ignoreversion replacesameversion; BeforeInstall: AddToDetaList; Components: Inno\Unicode and not ISCmplr_Setup
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack\isfiles-unicode\ISCC.exe; DestDir: {app}; DestName: ISCC.exe; Flags: ignoreversion replacesameversion; BeforeInstall: AddToDetaList; Components: Inno\Unicode and not ISCmplr_Setup
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack\isfiles-unicode\*.e32; DestDir: {app}; Flags: ignoreversion replacesameversion; BeforeInstall: AddToDetaList; Components: Inno\Unicode and not ISCmplr_Setup
Source: E:\Version\Inno\Inno-All-in-One-Setup\IsPack\isfiles-unicode\ISCmplr.dll; DestDir: {app}; Flags: ignoreversion replacesameversion; BeforeInstall: AddToDetaList; Components: Inno\Unicode and not ISCmplr_Setup

Source: E:\Version\Inno\Inno-All-in-One-Setup\Docs\Hanzify Forum Inno Article.chm; DestDir: {app}\Docs; Flags: ignoreversion; Components: Help\Hanzify; Tasks:
Source: E:\Version\Inno\Inno-All-in-One-Setup\Docs\Inno Setup Extensions Knowledge Base.chm; DestDir: {app}\Docs; Flags: ignoreversion; Components: Help\Isxkb; Tasks:
...
Source: E:\Version\Inno\Inno-All-in-One-Setup\Docs\Inno Setup ISD Format.htm; DestDir: {app}\Docs; Flags: ignoreversion; Components: Help\ISD; Tasks:
Source: E:\Version\Inno\Inno-All-in-One-Setup\Docs\DelphiKey.htm; DestDir: {app}\Docs; Flags: ignoreversion; Components: Help; Tasks:

Source: E:\Version\Inno\Inno-All-in-One-Setup\\Res\ISetup.chm; DestDir: {app}; Languages: ChineseSimp; BeforeInstall: AddToDetaList; Flags: ignoreversion

;Extensions



    Source: E:\Version\Inno\Inno-All-in-One-Setup\Extensions\Graphics\*; DestDir: {app}\Extensions\Graphics; Components: ; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
...
;UninsHs
    ...
    Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\UninsHs.Iss; DestDir: {app}\Examples\; Components: Extensions\UninsHs; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList

    Source: E:\Version\Inno\Inno-All-in-One-Setup\Extensions\UninsHs\*; DestDir: {app}\Extensions\UninsHs; Components: Extensions\UninsHs; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
...
;Converter
    ...
    Source: E:\Version\Inno\Inno-All-in-One-Setup\Extensions\Converter\*; DestDir: {app}\Extensions\Converter; Components: Extensions\Converter; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
...
Source: E:\Version\Inno\Inno-All-in-One-Setup\Extensions\CodeFont\CourierNewEx.fon; DestDir: {app}\Extensions\CodeFont; Components: EasySets\CodeFont; Flags: onlyifdoesntexist ignoreversion fontisnttruetype; FontInstall: Courier New Ex; BeforeInstall: AddToDetaList
Source: E:\Version\Inno\Inno-All-in-One-Setup\Extensions\CodeFont\Megatops ProCoder 1.0.fon; DestDir: {app}\Extensions\CodeFont; Components: EasySets\CodeFont; Flags: onlyifdoesntexist ignoreversion fontisnttruetype; FontInstall: Megatops ProCoder 1.0; BeforeInstall: AddToDetaList
Source: E:\Version\Inno\Inno-All-in-One-Setup\Extensions\CodeFont\Raize.fon; DestDir: {app}\Extensions\CodeFont; Components: EasySets\CodeFont; Flags: onlyifdoesntexist ignoreversion fontisnttruetype; FontInstall: Raize; BeforeInstall: AddToDetaList

;SkyGz Enhanced Unpack Tools
Source: E:\Version\Inno\Inno-All-in-One-Setup\Extensions\Unpack\innounp.exe; DestDir: {app}\Extensions\Unpack; Flags: ignoreversion touch; Components:  Extensions\Unpack\InnoExp; BeforeInstall: AddToDetaList
Source: E:\Version\Inno\Inno-All-in-One-Setup\Extensions\Unpack\Languages\*.dll; DestDir: {app}\Extensions\Unpack\Languages; Flags: ignoreversion touch; Components:  Extensions\Unpack\InnoExp; BeforeInstall: AddToDetaList
Source: E:\Version\Inno\Inno-All-in-One-Setup\Extensions\Unpack\ISUnp.exe; DestDir: {app}\Extensions\Unpack; Components: Extensions\Unpack\InnoExp; BeforeInstall: AddToDetaList; Flags: ignoreversion touch
Source: E:\Version\Inno\Inno-All-in-One-Setup\Extensions\Unpack\Languages\*.lng; DestDir: {app}\Extensions\Unpack\Languages; Flags: ignoreversion touch; Components: Extensions\Unpack\InnoExp; BeforeInstall: AddToDetaList

Source: E:\Version\Inno\Inno-All-in-One-Setup\Extensions\Unpack\DisasmGUI.exe; DestDir: {app}\Extensions\Unpack; Components: Extensions\Unpack\Disasm; BeforeInstall: AddToDetaList; Flags: ignoreversion touch
Source: E:\Version\Inno\Inno-All-in-One-Setup\Extensions\Unpack\Disasm.exe; DestDir: {app}\Extensions\Unpack; Components: Extensions\Unpack\Disasm; BeforeInstall: AddToDetaList; Flags: ignoreversion touch

Source: E:\Version\Inno\Inno-All-in-One-Setup\Extensions\InnoLogView\*; DestDir: {app}\Extensions\InnoLogView; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList; Components: Extensions\InnoLogView

;Nsis Resouces
Source: E:\Version\Inno\Inno-All-in-One-Setup\\Nsis\Graphics\Header\*; DestDir: {app}\Extensions\Graphics\Nsis_Header; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList; Components: Nsis\Graphics\Header
Source: E:\Version\Inno\Inno-All-in-One-Setup\\Nsis\Graphics\Wizard\*; DestDir: {app}\Extensions\Graphics\Nsis_Wizard; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList; Components: Nsis\Graphics\Wizard
Source: E:\Version\Inno\Inno-All-in-One-Setup\\Nsis\Graphics\Icons\*; DestDir: {app}\Extensions\Graphics\Nsis_Icons; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList; Components: Nsis\Graphics\Icons
;MUIOrangeVistaTheme
Source: E:\Version\Inno\Inno-All-in-One-Setup\\Nsis\Graphics\MUIOrangeVistaTheme\*; DestDir: {app}\Extensions\Graphics\Nsis_MUIOrangeVistaTheme; Components: Nsis\Graphics\MUIOrangeVistaTheme; Tasks: ; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList
Source: E:\Version\Inno\Inno-All-in-One-Setup\\Nsis\Graphics\MUIOrangeVistaTheme_CD\*; DestDir: {app}\Extensions\Graphics\Nsis_MUIOrangeVistaTheme_CD; Components: Nsis\Graphics\MUIOrangeVistaTheme_CD; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList

;Examples
Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\UI\Install Shield Skins\*; DestDir: {app}\Examples\UI\Install Shield Skins; Tasks: ; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList
...
Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\UI\WaitingForm\*; DestDir: {app}\Examples\UI\WaitingForm; Tasks: ; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList
Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\Autorun\*; DestDir: {app}\Examples\Autorun; Tasks: ; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList

Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\browse for a machine.iss; DestDir: {app}\Examples; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\SelfDel.iss; DestDir: {app}\Examples; Flags: ignoreversion; BeforeInstall: AddToDetaList
;Mui_Nsis
Source: E:\Version\Inno\Inno-All-in-One-Setup\Include\MUIs\Mui_Nsis.Ish; DestDir: {app}\Include\MUIs; Components: Nsis; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\Inno\Inno-All-in-One-Setup\Include\MUIs\Mui_Nsis_Adv.Ish; DestDir: {app}\Include\MUIs; Components: Nsis; Tasks: ; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\Inno\Inno-All-in-One-Setup\Examples\UI\Mui_Nsis\*; DestDir: {app}\Examples\UI\Mui_Nsis; Components: Nsis; Tasks: ; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList

Source: E:\Version\Inno\Inno-All-in-One-Setup\Include\MUIs\AllMove.Ish; DestDir: {app}\Include\MUIs; Flags: ignoreversion; BeforeInstall: AddToDetaList

;Include
Source: E:\Version\Inno\Inno-All-in-One-Setup\Include\PreDefines.ish; DestDir: {app}\Include; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\Inno\Inno-All-in-One-Setup\Include\AnimateWindow.ish; DestDir: {app}\Include; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\Inno\Inno-All-in-One-Setup\Include\SHFileOperation.ish; DestDir: {app}\Include; Flags: ignoreversion; BeforeInstall: AddToDetaList
Source: E:\Version\Inno\Inno-All-in-One-Setup\Include\ExecAndWait.Ish; DestDir: {app}\Include; Flags: ignoreversion; BeforeInstall: AddToDetaList

;Plugin
Source: E:\Version\Inno\Inno-All-in-One-Setup\Plugins\ISCrypt.dll; DestDir: {app}; Flags: ignoreversion; BeforeInstall: AddToDetaList

;Languages
Source: E:\Version\Inno\Inno-All-in-One-Setup\\Res\Languages\*; DestDir: {app}\Languages; Components:  not (ISCmplr_Setup\Restools_MiniVCL or ISCmplr_Setup\Restools_FullVCL); Tasks: ; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList
...
begin
  ...
  begin
    ...
    if CompareVersion(Ver, '2021.2.17.11') > 0 then  //ÓÐ¸üÐÂ
    begin
...
if not WizardForm.WelcomePage.Visible then
  ...
  begin
    ShowBalloon(As_Tips[Random(GetArrayLength(As_Tips))], 'Inno Setup ¼¯³É°æ 5.6.1', 0, 10, False);
  end;
end;
