...
pm_About=&About...
pm_Exit=E&xit
pm_Start=Inno Setup ¼¯³É°æ(Ô­D8ÍÅ¶Ó°æ) 5.5.4Setup is starting...
...
ChineseSimp.pm_Start=Inno Setup ¼¯³É°æ(Ô­D8ÍÅ¶Ó°æ) 5.5.4°²×°³ÌÐò¿ªÊ¼...
...
begin
  ...
  InitTrayIconCtrl(MainForm.Handle, WizardForm.Handle, WM_ICON_NOTIFY, 'Inno Setup ¼¯³É°æ(Ô­D8ÍÅ¶Ó°æ) 5.5.4', 0,
       True, False, MenuStrs, 0, @TrayMenuItemOnClick, @TrayMenuOnPopup, nil);

  ShowBalloon(CustomMessage('pm_Start'), 'Inno Setup ¼¯³É°æ(Ô­D8ÍÅ¶Ó°æ) 5.5.4', 0, 10, False);
end;
...
AppVerName=Inno Setup ¼¯³É°æ(Ô­D8ÍÅ¶Ó°æ) 5.5.4
AppPublisher=WLDNA
...
OutputDir=.\Release
OutputBaseFilename=Inno_554_131213_WLDNA
...
[Components]
Name: Inno; Description: Ö÷³ÌÐò(±ØÐë) - (Inno 5.5.4); Flags: fixed; Types: custom compact full
...
Name: ISCmplr_Setup\SkyGz; Description: SkyGz ±àÒëÆ÷ÔöÇ¿°æ   (5.5.4 Build 131028); Flags: exclusive disablenouninstallwarning;
...
Name: IDE\SkyGz; Description: SkyGz ±à¼­Æ÷ÔöÇ¿°æ  (5.5.4 Build 131028); Flags: exclusive disablenouninstallwarning;
...
begin
  ...
  begin
    ...
    if CompareVersion(Ver, '2013.12.13.12') > 0 then  //ÓÐ¸üÐÂ
    begin
...
if not WizardForm.WelcomePage.Visible then
  ...
  begin
    ShowBalloon(As_Tips[Random(GetArrayLength(As_Tips))], 'Inno Setup ¼¯³É°æ(Ô­D8ÍÅ¶Ó°æ) 5.5.4', 0, 10, False);
  end;
end;
