...
ChineseSimp.SetupAppTitle=KngStr - Inno Setup ¼¯³É°æ(Ô­D8ÍÅ¶Ó°æ)
...
;Help
Source: E:\Version\[Inno]\Inno-All-in-One-Setup\IsPack_SkyGz\Help\*; DestDir: {app}; Components: Inno; Languages: ChineseSimp; BeforeInstall: AddToDetaList; Flags: ignoreversion
...
pm_About=&About...
pm_Exit=E&xit
pm_Start=Inno Setup ¼¯³É°æ(Ô­D8ÍÅ¶Ó°æ) 5.5.9Setup is starting...
...
ChineseSimp.pm_Start=Inno Setup ¼¯³É°æ(Ô­D8ÍÅ¶Ó°æ) 5.5.9°²×°³ÌÐò¿ªÊ¼...
...
begin
  ...
  InitTrayIconCtrl(MainForm.Handle, WizardForm.Handle, WM_ICON_NOTIFY, 'Inno Setup ¼¯³É°æ(Ô­D8ÍÅ¶Ó°æ) 5.5.9', 0,
       True, False, MenuStrs, 0, @TrayMenuItemOnClick, @TrayMenuOnPopup, nil);

  ShowBalloon(CustomMessage('pm_Start'), 'Inno Setup ¼¯³É°æ(Ô­D8ÍÅ¶Ó°æ) 5.5.9', 0, 10, False);
end;
...
[Setup]
AppId=Inno Setup 5
AppName=Inno Setup ¼¯³É°æ(Ô­D8ÍÅ¶Ó°æ)
AppVerName=Inno Setup ¼¯³É°æ(Ô­D8ÍÅ¶Ó°æ) 5.5.9
AppPublisher=KngStr
...
VersionInfoVersion=2016.4.23.19
;#ifndef Test
...
OutputDir=.\Release
OutputBaseFilename=Inno_559_160423_KngStr
...
Name: ISCmplr_Setup\SkyGz; Description: SkyGz ±àÒëÆ÷ÔöÇ¿°æ   (5.5.9 Build 160408); Flags: exclusive disablenouninstallwarning;
...
Name: IDE\SkyGz; Description: SkyGz ±à¼­Æ÷ÔöÇ¿°æ  (5.5.9 Build 160408); Flags: exclusive disablenouninstallwarning;
...
[Components]
Name: IDE\ISStudio; Description: Inno Script Studio     (2.1.0.20 Build 130430); Types: full compact custom
...
;ISTask
  ...
  Source: E:\Version\[Inno]\Inno-All-in-One-Setup\Plugins\Nsis\*; DestDir: {app}\Plugins\Nsis; Components: Plugins\CallNsis; Tasks: ; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList
  ;WaterCtrl
...
Name: Restools_Lang_En; Description: ¼æÈÝRestoolsÉè¼ÆÆ÷£¬Ê¹ÓÃÓ¢ÎÄÓïÑÔÎÄ¼þ×÷ÎªÄ¬ÈÏÓïÑÔ; GroupDescription: Restools±à¼­Æ÷¸½¼ÓÑ¡Ïî; Components: Extensions\Unpack\InnoExp;
...
Source: E:\Version\[Inno]\Inno-All-in-One-Setup\IsPack\isfiles\*; Excludes: .git*,cvs\*,ISPP.dll,*.e32,Compil32.exe,isscint.dll,ISPPCC.exe,ISCC.exe,ISCmplr.dll; DestDir: {app}; Flags: ignoreversion recursesubdirs; BeforeInstall: AddToDetaList; Components: Inno
...
;Languages
Source: E:\Version\[Inno]\Inno-All-in-One-Setup\\Res\Languages\*; DestDir: {app}\Languages; Components: ; Tasks: ; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: AddToDetaList
...
[Icons]
Name: {commondesktop}\Inno Setup ¼¯³É°æ(Ô­D8ÍÅ¶Ó°æ); Filename: {app}\Compil32.exe; Tasks: DesktopIcon
Name: {userappdata}\Microsoft\Internet Explorer\Quick Launch\Inno Setup ¼¯³É°æ(Ô­D8ÍÅ¶Ó°æ); Filename: {app}\Compil32.exe; Tasks: QuickLaunchIcon

;Name: {group}\{#AppName}; Filename: {app}\{#AppExeName}
Name: {group}\{cm:UninstallProgram,Inno Setup ¼¯³É°æ(Ô­D8ÍÅ¶Ó°æ)}; Filename: {uninstallexe}
...
begin
  ...
  begin
    ...
    if CompareVersion(Ver, '2016.4.23.19') > 0 then  //ÓÐ¸üÐÂ
    begin
...
if not WizardForm.WelcomePage.Visible then
  ...
  begin
    ShowBalloon(As_Tips[Random(GetArrayLength(As_Tips))], 'Inno Setup ¼¯³É°æ(Ô­D8ÍÅ¶Ó°æ) 5.5.9', 0, 10, False);
  end;
end;
